        ...
        fetch(urlVille)
            ...
            .then(resJson => {
                $('#temperature').text(resJson.main.temp + "°"),
                    ...
                    $('#divMap').html("<iframe id='map'src='https://www.google.com/maps/embed/v1/view?key=AIzaSyCBdOfwbLBMGhe9K77dPqD0x849yNQim3E&center=" + resJson.coord.lat + "," + resJson.coord.lon + "&zoom=11&maptype=satellite'></iframe>");
            });
    });
});